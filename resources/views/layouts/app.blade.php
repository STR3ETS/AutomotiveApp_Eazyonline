    ...
    <div class="px-[1rem] py-[1.5rem] bg-[var(--primary-color)] flex flex-col gap-16">
        ...
        <div>
            ...
            <div class="flex flex-col">
                ...
                <!-- Altijd zichtbaar -->
                <a href="/" class="flex items-center transition duration-200 rounded-[var(--border-radius)] hover:bg-[var(--primary-lighter)]">
                ...
                <a href="/agenda" class="flex items-center transition duration-200 rounded-[var(--border-radius)] hover:bg-[var(--primary-lighter)]">
                    <div class="flex items-center gap-2 w-[200px] p-2">
                ...
                <a href="/pipeline" class="flex items-center transition duration-200 rounded-[var(--border-radius)] hover:bg-[var(--primary-lighter)]">
                    <div class="flex items-center gap-2 w-[200px] p-2">
                ...
                <a href="/repairs" class="flex items-center transition duration-200 rounded-[var(--border-radius)] hover:bg-[var(--primary-lighter)]">
                    <div class="flex items-center gap-2 w-[200px] p-2">
                ...
                @if(Auth::check() && Auth::user()->employee?->position === 'medewerker')
                    <a href="{{ route('employees.show', Auth::user()->employee) }}" class="flex items-center transition duration-200 rounded-[var(--border-radius)] hover:bg-[var(--primary-lighter)]">
                        <div class="flex items-center gap-2 w-[200px] p-2">
                ...
                <!-- Voor iedereen -->
                <a href="{{ route('autos.index') }}" class="flex items-center transition duration-200 rounded-[var(--border-radius)] hover:bg-[var(--primary-lighter)]">
                    <div class="flex items-center gap-2 w-[200px] p-2">
                ...
                <a href="{{ route('sales-ready.index') }}" class="flex items-center transition duration-200 rounded-[var(--border-radius)] hover:bg-[var(--primary-lighter)]">
                    <div class="flex items-center gap-2 w-[200px] p-2">
                ...
                <a href="{{ route('customers.index') }}" class="flex items-center transition duration-200 rounded-[var(--border-radius)] hover:bg-[var(--primary-lighter)]">
                    <div class="flex items-center gap-2 w-[200px] p-2">
                ...
                <a href="{{ route('employees.index') }}" class="flex items-center transition duration-200 rounded-[var(--border-radius)] hover:bg-[var(--primary-lighter)]">
                    <div class="flex items-center gap-2 w-[200px] p-2">
                ...
                <a href="{{ route('active-sales.index') }}" class="flex items-center transition duration-200 rounded-[var(--border-radius)] hover:bg-[var(--primary-lighter)]">
                    <div class="flex items-center gap-2 w-[200px] p-2">
                ...
                <!-- Alleen owners -->
                @if(!Auth::check() || Auth::user()->employee?->position !== 'medewerker')
                    <a href="{{ route('reports.index') }}" class="flex items-center transition duration-200 rounded-[var(--border-radius)] hover:bg-[var(--primary-lighter)]">
                        <div class="flex items-center gap-2 w-[200px] p-2">
                    ...
                    <a href="{{ route('company-settings.index') }}" class="flex items-center transition duration-200 rounded-[var(--border-radius)] hover:bg-[var(--primary-lighter)]">
                        <div class="flex items-center gap-2 w-[200px] p-2">
                            <i class="fa-solid fa-gear fa-sm text-[var(--text-white)]"></i>
                            <p class="text-sm text-[var(--text-white)] font-semibold tracking-tighter">Bedrijfsinstellingen</p>
                        </div>
                    </a>
                @endif
